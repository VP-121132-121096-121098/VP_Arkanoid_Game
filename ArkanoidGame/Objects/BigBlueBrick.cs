...
{
    public class BigBlueBrick //: AbstractBrick
    {

        /*public override void InitTextures()
        {
            ObjectTextures = new List<GameBitmap>();
            ObjectTextures.Add(new GameBitmap("\\Resources\\Images\\element_blue_rectangle.png", PositionUL,
                PositionUR, PositionDL));
        }

        public BigBlueBrick(Vector2D positionVector, int virtualGameWidth, int virtualGameHeight)
