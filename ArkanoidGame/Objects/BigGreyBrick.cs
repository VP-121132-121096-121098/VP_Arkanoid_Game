...
{
    public class BigGreyBrick //: AbstractBrick
    {

       /* public override void InitTextures()
        {
            ObjectTextures = new List<GameBitmap>();
            ObjectTextures.Add(new GameBitmap("\\Resources\\Images\\element_grey_rectangle.png", PositionUL,
                PositionUR, PositionDL));
        }

        public BigGreyBrick(Vector2D positionVector, int virtualGameWidth, int virtualGameHeight)
