...
{
    public class BigGreenBrick : AbstractBrick
    {
        
        public override void InitTextures()
        {
            ObjectTextures = new List<GameBitmap>();
            ObjectTextures.Add(new GameBitmap("\\Resources\\Images\\element_green_rectangle.png", PositionUL,
                PositionUR, PositionDL));
        }

        public BigGreenBrick(Vector2D positionVector, int virtualGameWidth, int virtualGameHeight)
